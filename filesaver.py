file = open("booker.html", "w")
file.write("""
indexmodules |next |previous | Python » 
English
...
Show Source
«
indexmodules |next |previous | Python » 3.9.2 Documentation » The Python Tutorial »
Quick search
  |
© Copyright 2001-2021, Python Software Foundation.
The Python Software Foundation is a non-profit corporation. Please donate.

Last updated on Feb 28, 2021. Found a bug?
""")
file.close()